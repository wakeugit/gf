...
public class TablePrinter {
     ...
     */
    public static <T> void print(TableView<T> tableView, PrinterJob jobArg, Stage owner) {
        ...
        printWithJob(tableView, job, owner);
        if (createJob) {
            job.endJob();
        }
    }
     ...
     *            See description.
     */
    private static <T> void printWithJob(TableView<T> tableView, PrinterJob job, Stage owner) {
        TableView<T> copyView = createTableCopy(tableView, job, owner);
    ...
    private static <T> void printPage(PrinterJob job, TableView<T> copyView, ArrayList<T> itemList) {
        ...
        pane.getChildren().addAll(copyView);
    ...
    private static <T> TableView<T> createTableCopy(TableView<T> tableView, PrinterJob job, Stage owner) {
        ...
        copyView.setItems(tableView.getItems());
        System.out.println(copyView.getItems().size());
        new Scene(copyView);
